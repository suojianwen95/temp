package yun.controllers.customer;
...
public class SoftController extends BaseController {
    ...
    public Result index (Context context,
        ...
        Page<Soft> page = softService.listPagedByCondition(p,limit, member, categoryId, name,"sequence","DESC");
    ...
    public Result create(Context context, @Param("attach") FileItem fileItem) {
        ...
        if (fileItem == null || fileItem.getFile() == null || "".equals(fileItem.getFileName())){
            ...
            return Results.html().template("/yun/views/customer/SoftController/add.ftl.html")
        ...
        if (sdo.isSuccess()){
            ...
            return Results.redirect("/customer/soft/show/"+sdo.getItem().getId());
        }else {
            context.getFlashScope().error(sdo.getMessage());
            return Results.html().template("/yun/views/customer/SoftController/add.ftl.html").render("item",dto).render("categoryList",categoryList);
        }
    }
    ...
    public Result edit(Context context, @PathParam("id") Long id){
        ...
        if (null == soft){
            ...
            return Results.redirect("/customer/soft");
        }
    ...
    public Result update(Context context,
        ...
        if (sdo.isSuccess()){
            ...
            context.getFlashScope().error(sdo.getMessage());
            return Results.html().template("/yun/views/customer/SoftController/edit.ftl.html").render("item",dto).render("id",soft.getId()).render("categoryList",categoryList);
        }
    }
